...
int main(int argc, char* argv[])
{
	...
	const auto mat = triangleList.addMaterial(Material::light(vec3(2)));

	//triangleList.loadModel(sphere, 1.0f, glm::translate(mat4(1.0f), vec3(8.0f, 3.7f, 0.0f)), mat);
	triangleList.loadModel(sphere, 1.0f, glm::translate(mat4(1.0f), vec3(4.0f, 40.0f, 0.0f)), mat);
	...
	Material m = Material::lambertian(vec3(1, 0.2, 0.2));
