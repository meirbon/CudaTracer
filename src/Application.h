...
private:
	...
	void free();
	void updateMaterials(int matIdx, Material* mat);
	void drawUI();
	...
	Material* m_SelectedMat = nullptr;

	void getMaterialAtPixel(const MBVHNode* nodes, const unsigned int* primIndices, TriangleList& tList, core::Camera& camera, int x, int y);
};
