...
class QuarticEquation
{
  ...
  public:
    ...
    inline void Function(const double *x, double *y) const
    {
    ...
    inline void Jacobian(const double *x, double *J) const
    {
        const double x2 = x[0] * x[0];
        const double x3 = x[0] * x2;
  ...
  private:
    void solve_cubic_equation(double c3, double c2, double c1, double c0,
